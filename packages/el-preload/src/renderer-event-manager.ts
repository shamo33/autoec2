...
export class RendererEventManager<T extends RendererEventReceiver> {
  #instanceName: string;
  #eventName: string;
  #receiverCount = 0;
  ...
  createEventHub() {
    return {
      addReceiver: this.#addReceiver.bind(this),
      removeReceiver: this.#removeReceiver.bind(this),
    } as RendererEventHub<T>;
  }
}
